...
# Contributing to {scShardSplitRef}

This outlines how to propose a change to {scShardSplitRef}.
...
- Fork the package and clone onto your computer. If you haven't done this before, we recommend using `usethis::create_from_github("AAGI-Org-AU-Public/scShardSplitRef", fork = TRUE)`.
...
Please note that the {scShardSplitRef} project is released with a [Contributor Code of Conduct](CODE_OF_CONDUCT.md).
