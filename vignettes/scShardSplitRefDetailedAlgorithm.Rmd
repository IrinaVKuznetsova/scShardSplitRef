...
This toy dataset provides a minimal example to demonstrate the logic of the algorithm that prepares compatible reference files (GTF and FASTA) for `cellranger-arc mkref`. It allows users to test the workflow using toy data and explains the algorithm logic in detail.
...
| Centromere coordinates | BED-like | Centromere positions per chromosome (x) | extdata/AlgorithmToy.bed |
...
##### The Help Page for `validate_inputs()`
...
> If the GTF and BED formats are correct, a confirmation message will be printed to the console:\
> *"All files loaded and validated successfully"*



#### 2. Determine Split Regions
...
##### Algorithm Explanation: How `determine_split_regions()` works 
...
```
      ...
      chr0: 0    100  200                       800
            ...
            The centromere coordinate is define in the BED file (chr0:450-800)
...
```
      ...
      chr4: 0     50  100                        800   900     1500
            ...
            The centromere coordinate is define in the BED file (chr4:300-1500) ->
...
#### 3. Process a GTF file by assigning split-region sequence names
